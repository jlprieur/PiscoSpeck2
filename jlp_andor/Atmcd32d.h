...
// DDG Lite functions
EXPNETTYPE unsigned int WINAPI GetDDGLiteGlobalControlByte(unsigned char * _byte);
EXPNETTYPE unsigned int WINAPI GetDDGLiteControlByte(AT_DDGLiteChannelId _channel, unsigned char * _byte);
EXPNETTYPE unsigned int WINAPI GetDDGLiteInitialDelay(AT_DDGLiteChannelId _channel, float * _f_delay);
EXPNETTYPE unsigned int WINAPI GetDDGLitePulseWidth(AT_DDGLiteChannelId _channel, float * _f_width);
EXPNETTYPE unsigned int WINAPI GetDDGLiteInterPulseDelay(AT_DDGLiteChannelId _channel, float * _f_delay);
EXPNETTYPE unsigned int WINAPI GetDDGLitePulsesPerExposure(AT_DDGLiteChannelId _channel, at_u32 * _ui32_pulses);
...
EXPNETTYPE unsigned int WINAPI GetMCPGainRange(int * _i_low, int * _i_high);
...
EXPNETTYPE unsigned int WINAPI GetVersionInfo(AT_VersionInfoId _id, char * _sz_versionInfo, at_u32 _ui32_bufferLen);
...
EXPNETTYPE unsigned int WINAPI IsCoolerOn(int * _iCoolerStatus);
...
// DDG Lite functions
EXPNETTYPE unsigned int WINAPI SetDDGLiteGlobalControlByte(unsigned char _byte);
EXPNETTYPE unsigned int WINAPI SetDDGLiteControlByte(AT_DDGLiteChannelId _channel, unsigned char _byte);
EXPNETTYPE unsigned int WINAPI SetDDGLiteInitialDelay(AT_DDGLiteChannelId _channel, float _f_delay);
EXPNETTYPE unsigned int WINAPI SetDDGLitePulseWidth(AT_DDGLiteChannelId _channel, float _f_width);
EXPNETTYPE unsigned int WINAPI SetDDGLiteInterPulseDelay(AT_DDGLiteChannelId _channel, float _f_delay);
EXPNETTYPE unsigned int WINAPI SetDDGLitePulsesPerExposure(AT_DDGLiteChannelId _channel, at_u32 _ui32_pulses);
...
EXPNETTYPE unsigned int WINAPI SetMultiTrackHRange(int _iStart, int _iEnd);
...
EXPNETTYPE unsigned int WINAPI SetNumberPrescans(int _i_number);
