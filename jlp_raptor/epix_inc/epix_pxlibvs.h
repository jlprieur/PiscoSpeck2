...
struct pxcamcntl {
    ...
    int     cntlcntinit;    /* data[] used	      fourth in data[]	*/
    int     cntlcntadj;     /* data[] used	      fifth  in data[]	*/
    int     cntlcntdeinit;  /* data[] used	      sizth  in data[]	*/
    ...
    int     cntladrs;	    /* varies					*/
    int     cntlcntrcvmask; /* data[] used	      third in data[]	*/
    int     rsvd2[5];
