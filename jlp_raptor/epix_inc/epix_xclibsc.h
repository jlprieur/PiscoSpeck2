/*
 *
 *	xclibsc.h	External	06-Oct-2016
 *
 *	Copyright (C)  1999-2016  EPIX, Inc.  All rights reserved.
 *
...
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_PIXCIclose(void);
...
_cDcl(_dllpxlib,_cfunfcc,int)		pxd_infoUnits(void);
_cDcl(_dllpxlib,_cfunfcc,char*) 	pxd_infoDriverId(void);
_cDcl(_dllpxlib,_cfunfcc,char*) 	pxd_infoLibraryId(void);
 ...
 * Image info
 */
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageXdim(void);
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageYdim(void);
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageCdim(void);
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageBdim(void);
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageZdim(void);
_cDcl(_dllpxlib,_cfunfcc,int)	    pxd_imageIdim(void);
_cDcl(_dllpxlib,_cfunfcc,double)    pxd_imageAspectRatio(void);
...
_cDcl(_dllpxlib,_cfunfcc,uint32)	pxd_capturedSysTicksHi(int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,uint32)	pxe_capturedSysTicksHi(pxdstate_s*,int unitmap);
...
_cDcl(_dllpxlib,_cfunfcc,double) pxd_SV1310_getMinMaxFramePeriod(int unitmap, double frameperiod);
...
_cDcl(_dllpxlib,_cfunfcc,int)	  pxd_SILICONVIDEO_getMinMaxResolution(int unitmap,int subsamplep[],int aoileftp[],int aoitopp[],int aoiwidthp[],int aoiheightp[],int scandirectionp[],int bitdepthp[],int rsvd3[],int rsvd4[]);
...
_cDcl(_dllpxlib,_cfunfcc,int)	  pxe_SILICONVIDEO_getMinMaxResolution(pxdstate_s*,int unitmap,int subsamplep[],int aoileftp[],int aoitopp[],int aoiwidthp[],int aoiheightp[],int scandirectionp[],int bitdepthp[],int rsvd3[],int rsvd4[]);
...
#define SILICONVIDEO_20MCL    20000
#define SILICONVIDEO_1820CL   1820
