/*
 *
 *	pxlibsv.h	External	28-Feb-2016
 *
...
struct pxbufstatus2 {
    ...
    uint	captgptrig;	/* G.P Trig Count when captured 		    */
...
#define PXMOS_BUFSTATUS2    (PXMOS_DDCH+14)
typedef struct pxbufstatus2 pxbufstatus2_s;
