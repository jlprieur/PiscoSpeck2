/*
 *
 *	xclibsv.h	External	29-Jul-2016
 *
...
#define PIXCI_E4V7G	0x0044	// version 7G supports gen2 x4
#define PIXCI_E4DBV7G	0x0045	// version 7G supports gen2 x4
...
#define xclib_InitVidStateStructs2(Name, Model)        \
	  ...
	  /*Name.camcntl      = NULL; */	       \
	    ...
	    Name_##vidmem   .ddch.len = sizeof(Name_##vidmem);	   Name_##vidmem.ddch.mos    = PXMOS_VIDMEM;	   \
	    Name_##camcntl  .ddch.len = sizeof(Name_##camcntl);    Name_##camcntl.ddch.mos   = PXMOS_CAMCNTL;	   \
	    if (Model == PIXCI_A310 || Model == PIXCI_A110 || Model == PIXCI_A1107I1O) { \
