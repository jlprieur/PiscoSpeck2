...
//   CreateProperty("TriggerDevice","", MM::String, false, pAct);
   ...
   // TE Fan
   if(cameraType_ == _RAPTOR_CAMERA_OWL_NINOX_640 || cameraType_ == _RAPTOR_CAMERA_OSPREY || cameraType_ == _RAPTOR_CAMERA_OSPREY_RGB )
   {
...
int CRaptorEPIX::SnapImage()
{
	...
	{
	   MyTime startTime = GetCurrentMMTime();
...
//	double dCurrentClock1 = myClock();
   ...
   //MyTime timeStamp = this->GetCurrentMMTime();
...
int CRaptorEPIX::OnTestProperty(MyPropertyBase* pProp, MyActionType eAct, long indexx)
{
...
int CRaptorEPIX::OnGain(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(_IS_CAMERA_OWL_FAMILY || ((cameraType_ & _RAPTOR_CAMERA_COMMONCMDS1) > 0))
...
int CRaptorEPIX::OnTrigDelay(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(_IS_CAMERA_OWL_FAMILY)
...
int CRaptorEPIX::OnTriggerTimeout(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnUseSerialLog(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnFrameInterval(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnVideoPeak(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnVideoAvg(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	if(ForceUpdate_)
...
int CRaptorEPIX::OnCCDTemp(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnPCBTemp(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnMicroReset(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
   }
...
int CRaptorEPIX::OnExtTrigger(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnTrigger(MyPropertyBase* pProp, MyActionType eAct)
{
   if(!(cameraType_ & _RAPTOR_CAMERA_COMMONCMDS1 ))
	   return DEVICE_OK;
...
int CRaptorEPIX::OnFixedFrameRate(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnFrameRate(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnFrameAccumulate(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnFrameRateUser(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnCaptureMode(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnExposure(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnTECSetPoint(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnNUCState(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnPeakAvgLevel(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnAutoLevel(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnBlackOffset(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnAGCSpeed(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnExpSpeed(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnROIAppearance(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
/////////////////////////////////////////////////////////
int CRaptorEPIX::OnHorizontalFlip(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnBadPixel(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnInvertVideo(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnImageSharpen(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnShutterMode(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnShutterDelayOpen(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnShutterDelayClose(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
void CRaptorEPIX::SetHorizontalFlip(bool val)
{
	...
	{
		unsigned char ctrl;
		ctrl = FPGACtrl_ = (unsigned char) GetFPGACtrl();
		if(val)
...
/////////////////////////////////////////////////////////
int CRaptorEPIX::OnAutoExposure(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CRaptorEPIX::OnHighGain(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnHighPreAmpGain(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	   if(ForceUpdate_)
...
int CRaptorEPIX::OnForceUpdate(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(ForceUpdate_)
...
int CRaptorEPIX::OnUseDefaults(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  pProp->Set(g_Keyword_Off);
...
int CRaptorEPIX::OnPostCaptureROI(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
	  if(PostCaptureROI_)
...
int CRaptorEPIX::OnMaximumExposure(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
*/
int CRaptorEPIX::OnBinning(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnBinningX(MyPropertyBase* pProp, MyActionType eAct)
{
	return OnBinningXY(pProp, eAct, true);
}

int CRaptorEPIX::OnBinningY(MyPropertyBase* pProp, MyActionType eAct)
{
...
* Handles "Binning" property.
*/
int CRaptorEPIX::OnBinningXY(MyPropertyBase* pProp, MyActionType eAct, bool bBinX)
{
	//thd_->Suspend(); MMThreadGuard g(imgPixelsLock_);
...
*/
int CRaptorEPIX::OnPixelType(MyPropertyBase* pProp, MyActionType eAct)
{
...
*/
int CRaptorEPIX::OnBitDepth(MyPropertyBase* pProp, MyActionType eAct)
{
...
*/
int CRaptorEPIX::OnReadoutTime(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnDropPixels(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnSaturatePixels(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnFractionOfPixelsToDropOrSaturate(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnEPIXMultiUnitMask(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long val = 0;
...
int CRaptorEPIX::OnEPIXUnit(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long val = 0;
...
int CRaptorEPIX::OnTECooler(MyPropertyBase* pProp, MyActionType eAct)
{
	thd_->Suspend(); MMThreadGuard g(g_serialLock_[UNITSOPENMAP]);
...
int CRaptorEPIX::OnTECFan(MyPropertyBase* pProp, MyActionType eAct)
{
	thd_->Suspend(); MMThreadGuard g(g_serialLock_[UNITSOPENMAP]);
...
int CRaptorEPIX::OnAntiBloom(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	  int val=0;
...
int CRaptorEPIX::OnReadoutRate(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	   if((cameraType_ & _RAPTOR_CAMERA_EAGLE_BASE) )
...
int CRaptorEPIX::OnReadoutMode(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	  string mode;
...
int CRaptorEPIX::OnHighDynamicRange(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	  int val=0;
...
int CRaptorEPIX::OnNUCMap(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	  int val=0;
...
int CRaptorEPIX::OnTestPattern(MyPropertyBase* pProp, MyActionType eAct)
{
	thd_->Suspend(); MMThreadGuard g(g_serialLock_[UNITSOPENMAP]);
...
int CRaptorEPIX::OnDebayerMethod(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
	  string mode;
...
int CRaptorEPIX::OnUseAOI(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
         if(IsCapturing())
...
int CRaptorEPIX::OnAOILeft(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
         if(IsCapturing())
...
int CRaptorEPIX::OnAOITop(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
         if(IsCapturing())
...
int CRaptorEPIX::OnAOIWidth(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
         if(IsCapturing())
...
int CRaptorEPIX::OnAOIHeight(MyPropertyBase* pProp, MyActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
         if(IsCapturing())
...
*/
int CRaptorEPIX::OnScanMode(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnCameraCCDXSize(MyPropertyBase* pProp , MyActionType eAct)
{
...
int CRaptorEPIX::OnCameraCCDYSize(MyPropertyBase* pProp, MyActionType eAct)
{
...
int CRaptorEPIX::OnTriggerDevice(MyPropertyBase* pProp, MyActionType eAct)
{
